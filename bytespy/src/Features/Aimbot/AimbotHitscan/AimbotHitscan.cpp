...
int CAimbotHitscan::CanHit(Target_t& tTarget, CTFPlayer* pLocal, CTFWeaponBase* pWeapon)
{
	...
	if (pDoubletapAngle && tTarget.m_iTargetType == TargetEnum::Player)
	{
		std::sort(vRecords.begin(), vRecords.end(),
			...
			{
				Vec3 vPosA = {
					a.m_BoneMatrix.m_aBones[iTargetBone][0][3],
					a.m_BoneMatrix.m_aBones[iTargetBone][1][3],
					a.m_BoneMatrix.m_aBones[iTargetBone][2][3]
				};
				Vec3 vPosB = {
					b.m_BoneMatrix.m_aBones[iTargetBone][0][3],
					b.m_BoneMatrix.m_aBones[iTargetBone][1][3],
					b.m_BoneMatrix.m_aBones[iTargetBone][2][3]
				};

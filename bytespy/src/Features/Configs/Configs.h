...
public:
	...
	bool SaveMovementShid(const std::string& configName);
	bool LoadMovementShid(const std::string& configName);
	bool RemoveConfigShid(const std::string& configName);
	...
	const std::string m_sConfigExtension = ".by";

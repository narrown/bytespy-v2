...
#include "../src/Features/ImGui/Menu/Menu.h"
#include "../src/SDK/Vars.h"
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    Color_t color = Vars::Menu::Theme::Accent.Value;
    auto checkedTopColor = ImColor(color.r, color.g, color.b, color.a);
    auto checkedBottomColor = checkedTopColor;
